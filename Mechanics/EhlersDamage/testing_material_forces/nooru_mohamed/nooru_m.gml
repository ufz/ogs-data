...
<OpenGeoSysGLI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.opengeosys.org/images/xsd/OpenGeoSysGLI.xsd" xmlns:ogs="http://www.opengeosys.org">
    ...
    <points>
        ...
        <point id="1" x="0.2" y="0" z="0" name="p_1"/>
        <point id="2" x="0.2" y="0.0975" z="0" name="p_2"/>
        <point id="3" x="0.2" y="0.2" z="0" name="p_3"/>
        <point id="4" x="0" y="0.2" z="0" name="p_4"/>
        <point id="5" x="0" y="0.1025" z="0" name="p_5"/>
    </points>
