...
<OpenGeoSysGLI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://www.opengeosys.org/images/xsd/OpenGeoSysGLI.xsd" xmlns:ogs="http://www.opengeosys.org">
    <name>plate3d_geometry</name>
    <points>
        <point id="0" x="0" y="0" z="0"/>
        <point id="1" x="0" y="0" z="0.025"/>
        <point id="2" x="0" y="1" z="0.025"/>
        <point id="3" x="0" y="1" z="0"/>

        <point id="4" x="5" y="0" z="0"/>
        <point id="5" x="5" y="0" z="0.025"/>
        <point id="6" x="5" y="1" z="0.025"/>
        <point id="7" x="5" y="1" z="0"/>
    </points>
